...
pretrained_model = '1116_visdon_pair_based_tcl_bright_Net_epoch_200.pkl'
from TCL_SuperResolution_Model_Visdon_validation import TCL_SuperResolution
...
def parse_args():
    ...
    parser.add_argument('--is_valid', type=bool, default=is_valid)
    ...
    parser.add_argument('--model_save_dir', type=str, default='./1028_trainning_model', help='Directory name to save models')
    parser.add_argument('--img_save_dir', type=str, default='./experiments/1028', help='Directory name to save validation pictures')
