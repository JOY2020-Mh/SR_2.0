...
def parse_args():
    ...
    parser.add_argument("--ckpt_path", type=str, default = 'lesrcnn_x4.pth')
    parser.add_argument("--group", type=int, default=1)
    parser.add_argument("--sample_dir", type=str, default = './1127_test_LESRCNN')
    parser.add_argument("--test_data_dir", type=str, default="./lj_test_image")
