...
if __name__ == "__main__":
    ...
    parser.add_argument('--GT_dir', nargs="+", type=str, default=['./'], help = 'GT directory')
    parser.add_argument('--LR_dir', nargs="+", type=str, default=['./'], help = 'LR directory')
    ...
    # loss parameters
    parser.add_argument('--loss', nargs="+", type=str, default=['vgg'], help = 'loss function: l1, ssim, gradient loss, vgg loss, color loss, tv loss')
    ...
    parser.add_argument('--vgg_indices', nargs="+", type=int, default=[2,7, 12, 21,30], help = 'vgg loss layer e.g. 2 7 12 21 30')
    parser.add_argument('--lambda_vgg', nargs="+", type=float, default=[0.05,0.05,0.05,0.1,0.5], help = 'weighting of total variation loss e.g. 0.05 0.05 0.05 0.1 0.5')

    opt = parser.parse_args()


    validation_dataset = dataset.SRDataset(opt)
    print('The overall number of images:', len(validation_dataset))

    # Define the dataloader
    validation_dataloader = DataLoader(validation_dataset, batch_size = 1, pin_memory = True)
    ...
    # Valid the model
    valid_model(validation_dataloader, generator, opt)
