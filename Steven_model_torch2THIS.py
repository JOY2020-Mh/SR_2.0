...
torch_model = 'epoch100_batchsize2.pth'
save_path = 'epoch100_batchsize2.model'
...
torch_model_dict = model.state_dict()
#torch_model_dict = torch.load(torch_model, map_location=torch.device('cpu'))
