...
from TCL_SuperResolution_Model_1120 import TCL_SuperResolution
...
def parse_args():
    ...
    parser.add_argument('--model_save_dir', type=str, default='./1120_visdon_trainning_model_based_tcl_bright', help='Directory name to save models')
    parser.add_argument('--img_save_dir', type=str, default='./experiments/1113', help='Directory name to save validation pictures')
